...
<p style="margin-bottom: 0;"><strong>试验装备</strong></p>

<div class="equipment-grid">
    <div class="equipment-card">
        <img src="../assets/images/electrochemical-workstation.jpg" alt="用于表面科学研究的先进电化学工作站" loading="lazy" decoding="async">
        <div class="equipment-caption">电化学工作站</div>
    </div>
    <div class="equipment-card">
        <img src="../assets/images/electroplating-power-supply.jpg" alt="用于薄膜技术的高精度电镀电源" loading="lazy" decoding="async">
        <div class="equipment-caption">电镀电源</div>
    </div>
    <div class="equipment-card">
        <img src="../assets/images/uv-laser-etching-machine.jpg" alt="用于微纳加工的紫外激光刻蚀机" loading="lazy" decoding="async">
        <div class="equipment-caption">紫外激光刻蚀机</div>
    </div>
    <div class="equipment-card">
        <img src="../assets/images/pvd-equipment.png" alt="用于薄膜涂层的 PVD（物理气相沉积）设备" loading="lazy" decoding="async">
        <div class="equipment-caption">PVD设备</div>
    </div>
</div>
